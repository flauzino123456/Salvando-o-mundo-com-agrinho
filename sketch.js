...
function draw() {
  ...
  let corFundo = lerpColor(color(30, 112, 26), color(300, 239, 100), 
...
function mostrarInformacoes() {
  textSize(26);
  fill(0);
  text("Plante árvores e nos ajude a salvar o mundo!",10, 30)
  textSize(14);
  fill('white');
...
function mostrarMensagemDeVitoria() {
  textSize(20);
  fill(0, 0, 0);
  text("🎉Parabéns! Você foi demais!", 100, 200);
  noLoop(); 
}
...
function mostrarMensagemDeDerrota() {
  textSize(20);
  fill(0, 0, 0);
  text("😒 Perdeu! O verão chegou mais rápido.", 100, 200);
  noLoop(); 
}
